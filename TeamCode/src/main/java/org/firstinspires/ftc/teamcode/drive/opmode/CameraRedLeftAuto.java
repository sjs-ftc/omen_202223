...
@Autonomous(name = "Auto: Red Left Camera", group = "Game")
public class CameraRedLeftAuto extends LinearOpMode {
    ...
    Pose2d startPose = RLstartPose;
    Pose2d stackPose = RLstackPose;
    Pose2d dropPose = RLdropPose;
    Pose2d readyPose = RLreadyPose;
    Pose2d parkingPose1 = RLparkingPose1;
    Pose2d parkingPose2 = RLparkingPose2;
    Pose2d parkingPose3 = RLparkingPose3;
