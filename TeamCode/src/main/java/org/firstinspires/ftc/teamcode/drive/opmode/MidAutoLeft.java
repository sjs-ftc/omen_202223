...
@Autonomous(name = "Mid Left", group = "a")
public class MidAutoLeft extends LinearOpMode {
    ...
    Pose2d startPose = MLstartPose;
    Pose2d stackPose = MLstackPose;
    Pose2d dropPose = MLdropPose;
    Pose2d cone5Pose = MLcone5Pose;
    Pose2d readyPose = MLreadyPose;
    Pose2d parkingPose1 = MLparkingPose1;
    Pose2d parkingPose2 = MLparkingPose2;
    Pose2d parkingPose3 = MLparkingPose3;
